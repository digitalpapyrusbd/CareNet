...
- [x] B1: Login as super admin
- [x] B2: Navigate to `/admin/translations`
- [ ] B3: Click "Export All Text" button (FAILED: Network Error)
- [ ] B4: Verify file downloads successfully (FAILED: No download)
- [ ] B5: Verify file name is correct
- [ ] B6: Open file - verify JSON structure is correct
- [ ] B7: Verify all text is present in export
- [ ] B8: Export "Menu Only" - verify smaller file (FAILED: Network Error)
- [ ] B9: Export "Page Content" - verify correct content
- [ ] B10: Create a new translation file (e.g., Hindi `hi.json`)
- [x] B11: Click "Import New Language" in admin panel
...
- [x] C1: Navigate to `/admin/translations/scrubber`
- [ ] C2: Click "Scan All Components" (FAILED: Network Error)
- [ ] C3: Wait for scan to complete (FAILED: Network Error)
- [ ] C4: Verify it found hardcoded strings (FAILED: Network Error)
