...
interface CaregiverPackageTemplateEditorProps {
  template: {
    id: string;
    name: string;
    description: string;
...
export function CaregiverPackageTemplateEditor({ template, onSave, onDelete }: CaregiverPackageTemplateEditorProps) {
    ...
    <div className="min-h-screen p-6">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 style={{ color: '#535353' }}>{t('caregiverpackagetemplateeditor.heading.editpackagetemplate')}</h1>
        ...
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>{t('caregiverpackagetemplateeditor.heading.basicinformation')}</h3>
          <div className="space-y-4">
            <div>
              <Label style={{ color: '#535353' }}>{t('caregiverpackagetemplateeditor.text.packagename')}</Label>
              <Input
            ...
            <div>
              <Label style={{ color: '#535353' }}>{t('caregiverpackagetemplateeditor.text.description')}</Label>
              <Textarea
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label style={{ color: '#535353' }}>{t('caregiverpackagetemplateeditor.text.joblimit')}</Label>
                <Input
                  type="number"
                  value={editedTemplate.jobLimit}
                  onChange={(e) => setEditedTemplate({ ...editedTemplate, jobLimit: Number(e.target.value) })}
                  disabled={!isEditing}
                  className="mt-2 bg-white/50 border-white/50"
                  style={{ color: '#535353' }}
                />
        ...
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>{t('caregiverpackagetemplateeditor.heading.features')}</h3>
