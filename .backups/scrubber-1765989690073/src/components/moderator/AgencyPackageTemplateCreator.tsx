  ...
  return (
    <div className="min-h-screen pb-6">
      <div className="p-6 max-w-2xl mx-auto">
        <h1 className="mb-6" style={{ color: '#535353' }}>{t('agencypackagetemplatecreator.heading.createagencypackaget')}</h1>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder={t('agencypackagetemplatecreator.placeholder.egelderlycarebasicpa')}
            ...
            <div>
              ...
              >
                <option value="">{t('agencypackagetemplatecreator.text.selectcategory')}</option>
                <option value="elderly_care">{t('agencypackagetemplatecreator.text.elderlycare')}</option>
                <option value="child_care">{t('agencypackagetemplatecreator.text.childcare')}</option>
                <option value="disability_care">{t('agencypackagetemplatecreator.text.disabilitycare')}</option>
                <option value="post_surgery">{t('agencypackagetemplatecreator.text.postsurgerycare')}</option>
                <option value="chronic_illness">{t('agencypackagetemplatecreator.text.chronicillnessmanage')}</option>
              </select>
            </div>

            <div>
              <Label style={{ color: '#535353' }}>{t('agencypackagetemplatecreator.text.description')}</Label>
              <Textarea
                value={description}
                onChange={(e) => setDescription(e.target.value)}
                placeholder={t('agencypackagetemplatecreator.placeholder.describethispackaget')}
                className="mt-2 bg-white/50 border-white/50"
                style={{ color: '#535353' }}
              />
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <Label style={{ color: '#535353' }}>{t('agencypackagetemplatecreator.text.servicesincluded')}</Label>
                ...
                {servicesIncluded.map((service, index) => (
                  <div key={index} className="flex gap-2">
                    <Input
                      ...
                      placeholder={t('agencypackagetemplatecreator.placeholder.egmedicationmanageme')}
