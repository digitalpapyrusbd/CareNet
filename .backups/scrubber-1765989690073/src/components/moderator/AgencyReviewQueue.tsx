...
export function AgencyReviewQueue({ applications, onReview }: AgencyReviewQueueProps) {
  ...
  return (
    <div className="min-h-screen pb-6">
      <div className="p-6">
        <h1 className="mb-6" style={{ color: '#535353' }}>{t('agencyreviewqueue.heading.agencyreviewqueue')}</h1>
        ...
        {filteredApplications.length === 0 ? (
          <div className="finance-card p-8 text-center">
            ...
            <p style={{ color: '#848484' }}>{t('agencyreviewqueue.text.noapplicationsinqueu')}</p>
          </div>
        ) : (
              ...
              <div key={app.id} className="finance-card p-4">
                ...
                <div className="flex items-center gap-4 mb-3 text-sm">
                  <div className="flex items-center gap-1">
                    ...
                    <span style={{ color: '#535353' }}>{t('agencyreviewqueue.text.tradelicense')}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    {app.documents.tin ? (
                      <CheckCircle className="w-4 h-4" style={{ color: '#7CE577' }} />
