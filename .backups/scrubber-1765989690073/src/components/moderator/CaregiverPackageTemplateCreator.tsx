  ...
  return (
    <div className="min-h-screen pb-6">
      <div className="p-6 max-w-2xl mx-auto">
        <h1 className="mb-6" style={{ color: '#535353' }}>{t('caregiverpackagetemplatecreator.heading.createcaregiverpacka')}</h1>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder={t('caregiverpackagetemplatecreator.placeholder.egprofessionalcaregi')}
            ...
            <div>
              ...
              >
                <option value="">{t('caregiverpackagetemplatecreator.text.selecttier')}</option>
                <option value="basic">{t('caregiverpackagetemplatecreator.text.basic')}</option>
                <option value="professional">{t('caregiverpackagetemplatecreator.text.professional')}</option>
                <option value="premium">{t('caregiverpackagetemplatecreator.text.premium')}</option>
              </select>
            </div>

            <div>
              <Label style={{ color: '#535353' }}>{t('caregiverpackagetemplatecreator.text.description')}</Label>
              <Textarea
                value={description}
                onChange={(e) => setDescription(e.target.value)}
                placeholder={t('caregiverpackagetemplatecreator.placeholder.describethissubscrip')}
                className="mt-2 bg-white/50 border-white/50"
                style={{ color: '#535353' }}
              />
            </div>
            ...
            <div>
              <Label style={{ color: '#535353' }}>{t('caregiverpackagetemplatecreator.text.monthlyjoblimit')}</Label>
              <Input
                type="number"
                value={jobLimit}
                onChange={(e) => setJobLimit(e.target.value)}
                placeholder={t('caregiverpackagetemplatecreator.placeholder.10leaveemptyforunlim')}
                className="mt-2 bg-white/50 border-white/50"
                style={{ color: '#535353' }}
              />
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <Label style={{ color: '#535353' }}>{t('caregiverpackagetemplatecreator.text.featuresincluded')}</Label>
                ...
                {features.map((feature, index) => (
                  <div key={index} className="flex gap-2">
                    <Input
                      ...
                      placeholder={t('caregiverpackagetemplatecreator.placeholder.egpriorityjobmatchin')}
