  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-md mb-8 text-center">
        ...
        <h1 className="mb-2" style={{ color: '#535353' }}>{t('login.heading.carenet')}</h1>
      ...
      <div className="w-full max-w-md finance-card p-8">
        <h2 className="mb-6 text-center" style={{ color: '#535353' }}>{t('login.heading.welcomeback')}</h2>
        
        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Phone Input */}
          <div className="space-y-2">
            <Label htmlFor="phone" style={{ color: '#535353' }}>{t('login.text.phonenumber')}</Label>
            <Input
              id="phone"
              type="tel"
              placeholder={t('login.placeholder.01xxxxxxxxx')}
              value={phone}
          ...
          {/* Password Input */}
          <div className="space-y-2">
            <Label htmlFor="password" style={{ color: '#535353' }}>{t('login.text.password')}</Label>
            <div className="relative">
              <Input
                id="password"
                type={showPassword ? "text" : "password"}
                placeholder={t('login.placeholder.enteryourpassword')}
                value={password}
                onChange={(e) => {
      ...
      <div className="mt-8 text-center text-sm" style={{ color: '#848484' }}>
        ...
        <p className="mt-2">{t('login.text.progressivewebapp')}</p>
      </div>
    </div>
  );
}