      ...
      <div className="p-6">
        ...
        <div className="finance-card p-6 mb-6">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm" style={{ color: '#848484' }}>{t('negotiationflow.text.originalprice')}</span>
        ...
        {stage === 'send' && (
          <div className="space-y-6">
            <div className="finance-card p-6">
              <h3 className="mb-4" style={{ color: '#535353' }}>{t('negotiationflow.heading.sendcounteroffer')}</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder={t('negotiationflow.placeholder.explainyourofferoran')}
            ...
            >
              <p className="text-sm" style={{ color: '#535353' }}>
                💡 <strong>{t('negotiationflow.text.negotiationtips')}</strong> Agencies typically respond within 24-48 hours. Be reasonable with your offer to increase chances of acceptance.
              </p>
            </div>
        ...
        {stage === 'waiting' && (
          <div className="space-y-6">
            <div className="text-center py-12 finance-card">
              ...
              <h2 className="mb-2" style={{ color: '#535353' }}>{t('negotiationflow.heading.waitingforagencyresp')}</h2>
            ...
            <div className="finance-card p-6">
              <h3 className="mb-4" style={{ color: '#535353' }}>{t('negotiationflow.heading.youroffer')}</h3>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span style={{ color: '#848484' }}>{t('negotiationflow.text.originalprice1')}</span>
                  <span style={{ color: '#535353' }}>৳{originalPrice.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span style={{ color: '#848484' }}>{t('negotiationflow.text.youroffer1')}</span>
                ...
                <div className="pt-3 border-t flex justify-between" style={{ borderColor: 'rgba(255, 255, 255, 0.5)' }}>
                  <span style={{ color: '#848484' }}>{t('negotiationflow.text.potentialsavings')}</span>
          ...
          <div className="space-y-6">
            <div className="finance-card p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 style={{ color: '#535353' }}>{t('negotiationflow.heading.agencyresponse')}</h3>
              </div>
            ...
            <div className="finance-card p-6">
              <h3 className="mb-4" style={{ color: '#535353' }}>{t('negotiationflow.heading.pricecomparison')}</h3>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span style={{ color: '#848484' }}>{t('negotiationflow.text.originalprice2')}</span>
                  <span style={{ color: '#535353' }}>৳{originalPrice.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span style={{ color: '#848484' }}>{t('negotiationflow.text.youroffer2')}</span>
                  <span style={{ color: '#848484' }}>৳{proposedPrice || '30,000'}</span>
                </div>
                <div className="flex justify-between">
                  <span style={{ color: '#848484' }}>{t('negotiationflow.text.agencycounter')}</span>
                  <span style={{ color: '#FFB3C1' }}>৳{agencyResponse.counterPrice.toLocaleString()}</span>
                </div>
                <div className="pt-3 border-t flex justify-between" style={{ borderColor: 'rgba(255, 255, 255, 0.5)' }}>
                  <span style={{ color: '#848484' }}>{t('negotiationflow.text.yoursavings')}</span>
