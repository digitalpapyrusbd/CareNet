  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md finance-card p-8">
        <h2 className="mb-6 text-center" style={{ color: '#535353' }}>{t('updatestock.heading.updatestock')}</h2>
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder={t('updatestock.placeholder.enternewquantity')}
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder={t('updatestock.placeholder.addanoteaboutthissto')}
              className="mt-2 bg-white/50 border-white/50"
              style={{ color: '#535353' }}
            />
          </div>
