    ...
    <div className="space-y-4">
      ...
      {activeTab === 'vitals' && (
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 space-y-4">
          <h3 className="font-semibold text-lg mb-4">{t('mobilecarelog.heading.recordvitals')}</h3>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <Input
                type="number"
                inputMode="numeric"
                placeholder={t('mobilecarelog.placeholder.systolic')}
              ...
              <Input
                type="number"
                inputMode="numeric"
                placeholder={t('mobilecarelog.placeholder.diastolic')}
      ...
      {activeTab === 'medication' && (
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 space-y-4">
          <h3 className="font-semibold text-lg mb-4">{t('mobilecarelog.heading.medicationlog')}</h3>
      ...
      {activeTab === 'meals' && (
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 space-y-4">
          <h3 className="font-semibold text-lg mb-4">{t('mobilecarelog.heading.meallog')}</h3>
          ...
          >
            <option value="breakfast">{t('mobilecarelog.text.breakfast')}</option>
            <option value="lunch">{t('mobilecarelog.text.lunch')}</option>
            <option value="dinner">{t('mobilecarelog.text.dinner')}</option>
            <option value="snack">{t('mobilecarelog.text.snack')}</option>
          </Select>

          <div>
            <label className="block text-sm font-medium mb-2">{t('mobilecarelog.text.description')}</label>
            <textarea
              ...
              placeholder={t('mobilecarelog.placeholder.describewhatwasserve')}
          ...
          <div>
            ...
            <div className="flex justify-between text-xs text-gray-500 mt-1">
              <span>{t('mobilecarelog.text.none')}</span>
              <span>{t('mobilecarelog.text.some')}</span>
              <span>{t('mobilecarelog.text.half')}</span>
              <span>{t('mobilecarelog.text.most')}</span>
              <span>{t('mobilecarelog.text.all')}</span>
            </div>
          </div>
      ...
      {activeTab === 'incident' && (
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 space-y-4">
          <h3 className="font-semibold text-lg mb-4">{t('mobilecarelog.heading.incidentreport')}</h3>
          ...
          >
            <option value="fall">{t('mobilecarelog.text.fall')}</option>
            <option value="medication_error">{t('mobilecarelog.text.medicationerror')}</option>
            <option value="behavioral">{t('mobilecarelog.text.behavioralissue')}</option>
            <option value="medical_emergency">{t('mobilecarelog.text.medicalemergency')}</option>
            <option value="other">{t('mobilecarelog.text.other')}</option>
          </Select>
          ...
          >
            <option value="low">{t('mobilecarelog.text.lowminorissue')}</option>
            <option value="medium">{t('mobilecarelog.text.mediumrequiresattent')}</option>
            <option value="high">{t('mobilecarelog.text.highurgent')}</option>
            <option value="critical">{t('mobilecarelog.text.criticalemergency')}</option>
          </Select>

          <div>
            <label className="block text-sm font-medium mb-2">{t('mobilecarelog.text.description1')}</label>
            <textarea
              className="w-full min-h-[120px] px-4 py-3 text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:text-white"
              placeholder={t('mobilecarelog.placeholder.describewhathappened')}
