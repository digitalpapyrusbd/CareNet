    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h2 className="mb-4" style={{ color: '#535353' }}>{t('offlinestate.heading.nointernetconnection')}</h2>
        ...
        {hasCachedContent && (
          <div className="finance-card p-4 mt-6">
            <h3 className="mb-2" style={{ color: '#535353' }}>{t('offlinestate.heading.offlinemode')}</h3>
