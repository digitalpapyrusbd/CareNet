    ...
    <div className="min-h-screen">
      ...
      <div className="px-6 pt-8 pb-12">
        ...
        <div className="text-center mb-8">
          <h1 className="mb-4" style={{ color: '#535353' }}>{t('landing.heading.carenet')}</h1>
      ...
      <div className="px-6 py-12">
        <h2 className="text-center mb-8" style={{ color: '#535353' }}>{t('landing.heading.whychoosecarenet')}</h2>
      ...
      <div className="px-6 py-12">
        <h2 className="text-center mb-8" style={{ color: '#535353' }}>{t('landing.heading.whatouruserssay')}</h2>
      ...
      <div className="px-6 py-12">
        <div className="finance-card p-8 text-center max-w-2xl mx-auto">
          <h2 className="mb-4" style={{ color: '#535353' }}>{t('landing.heading.readytogetstarted')}</h2>
      ...
      <div className="px-6 py-8 border-t border-white/30">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div>
              <h3 className="mb-3" style={{ color: '#535353' }}>{t('landing.heading.carenet1')}</h3>
              <p className="text-sm" style={{ color: '#848484' }}>
                Quality care, connected across Bangladesh
              </p>
            </div>
            <div>
              <h4 className="mb-3" style={{ color: '#535353' }}>{t('landing.heading.quicklinks')}</h4>
              <ul className="space-y-2 text-sm" style={{ color: '#848484' }}>
                <li><a href="#" className="hover:underline">{t('landing.text.aboutus')}</a></li>
                <li><a href="#" className="hover:underline">{t('landing.text.howitworks')}</a></li>
                <li><a href="#" className="hover:underline">{t('landing.text.termsconditions')}</a></li>
                <li><a href="#" className="hover:underline">{t('landing.text.privacypolicy')}</a></li>
              </ul>
            </div>
            <div>
              <h4 className="mb-3" style={{ color: '#535353' }}>{t('landing.heading.contact')}</h4>
