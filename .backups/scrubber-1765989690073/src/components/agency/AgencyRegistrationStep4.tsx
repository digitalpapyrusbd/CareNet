    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md finance-card p-8">
        <div className="text-center mb-6">
          ...
          <h2 style={{ color: '#535353' }}>{t('agencyregistrationstep4.heading.documentupload')}</h2>
          <p className="text-sm" style={{ color: '#848484' }}>{t('agencyregistrationstep4.text.step4of5')}</p>
        </div>
            ...
            <label className="mt-2 flex flex-col items-center justify-center p-6 rounded-lg border-2 border-dashed cursor-pointer hover:bg-white/30 transition-all"
              ...
              {files.tradeLicense ? (
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm" style={{ color: '#535353' }}>{t('agencyregistrationstep4.text.uploadtradelicense')}</p>
          ...
          <div>
            ...
            <label className="mt-2 flex flex-col items-center justify-center p-6 rounded-lg border-2 border-dashed cursor-pointer hover:bg-white/30 transition-all"
              ...
              {files.tinCertificate ? (
                ...
                <div className="text-center">
                  <Upload className="w-8 h-8 mx-auto mb-2" style={{ color: '#848484' }} />
                  <p className="text-sm" style={{ color: '#535353' }}>{t('agencyregistrationstep4.text.uploadtincertificate')}</p>
                  <p className="text-xs" style={{ color: '#848484' }}>PDF, JPG, PNG (Max 5MB)</p>
                </div>
              )}
              <input
          ...
          <div>
            ...
            <label className="mt-2 flex flex-col items-center justify-center p-6 rounded-lg border-2 border-dashed cursor-pointer hover:bg-white/30 transition-all"
              ...
              {files.companyLogo ? (
                ...
                <div className="text-center">
                  <Upload className="w-8 h-8 mx-auto mb-2" style={{ color: '#848484' }} />
                  <p className="text-sm" style={{ color: '#535353' }}>{t('agencyregistrationstep4.text.uploadcompanylogo')}</p>
