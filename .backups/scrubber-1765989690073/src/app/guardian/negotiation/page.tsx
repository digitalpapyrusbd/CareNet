      ...
      <div className="p-6">
        ...
        <div className="finance-card p-6 mb-6">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm" style={{ color: '#848484' }}>{t('page.text.originalprice')}</span>
        ...
        <div className="space-y-6">
          <div className="finance-card p-6">
            <h3 className="mb-4" style={{ color: '#535353' }}>{t('page.heading.sendcounteroffer')}</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder={t('page.placeholder.explainyourofferoran')}
          ...
          >
            <p className="text-sm" style={{ color: '#535353' }}>
              💡 <strong>{t('page.text.negotiationtips')}</strong> Agencies typically respond within 24-48 hours. Be reasonable with your offer to increase chances of acceptance.
            </p>
          </div>
