    ...
    <>
      ...
      <div className="w-full max-w-md mb-8">
        <div className="flex items-center justify-between mb-2">
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex items-center flex-1">
              ...
              >
                {1 > {t('page.text.s')} <Check className="w-5 h-5" /> : s}
              </div>
              {s < 3 && (
                <div 
        ...
        <div className="flex justify-between text-xs" style={{ color: '#848484' }}>
          <span>{t('page.text.account')}</span>
          <span>{t('page.text.verify')}</span>
          <span>{t('page.text.profile')}</span>
        </div>
      </div>

      {/* Card */}
      <div className="w-full max-w-md finance-card p-8">
        <h2 className="text-center mb-6" style={{ color: '#535353' }}>{t('page.heading.createaccount')}</h2>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              id="phone"
              type="tel"
              placeholder={t('page.placeholder.01xxxxxxxxx6')}
              value={phone}
          ...
          <div className="space-y-2">
            ...
            <Input
              id="email"
              type="email"
              placeholder={t('page.placeholder.youremailcom')}
              value={email}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                placeholder={t('page.placeholder.enterpassword')}
                value={password}
          ...
          <div className="space-y-2">
            ...
            <Input
              id="confirmPassword"
              type="password"
              placeholder={t('page.placeholder.confirmpassword')}
