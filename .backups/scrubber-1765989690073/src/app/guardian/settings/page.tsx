  ...
  return (
    <>
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <h1 className="mb-2" style={{ color: '#535353' }}>{t('page.heading.settings')}</h1>
          <p style={{ color: '#848484' }}>{t('page.text.manageyouraccountpre')}</p>
        </div>
        ...
        {activeTab === 'profile' && (
          <div className="finance-card p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 style={{ color: '#535353' }}>{t('page.heading.profileinformation')}</h2>
            </div>

            <div className="space-y-4">
              <div>
                <Label htmlFor="name" style={{ color: '#535353' }}>{t('page.text.fullname4')}</Label>
                <Input
                  id="name"
                  value={profile.name}
              ...
              <div>
                <Label htmlFor="email" style={{ color: '#535353' }}>{t('page.text.emailaddress1')}</Label>
                <Input
                  id="email"
                  type="email"
                  value={profile.email}
              ...
              <div>
                <Label htmlFor="phone" style={{ color: '#535353' }}>{t('page.text.phonenumber5')}</Label>
                <Input
                  id="phone"
                  type="tel"
                  value={profile.phone}
              ...
              <div>
                <Label htmlFor="address" style={{ color: '#535353' }}>{t('page.text.address3')}</Label>
                <Input
                  id="address"
        ...
        {activeTab === 'notifications' && (
          <div className="finance-card p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 style={{ color: '#535353' }}>{t('page.heading.notificationpreferen')}</h2>
            </div>
        ...
        {activeTab === 'security' && (
          <div className="finance-card p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 style={{ color: '#535353' }}>{t('page.heading.securitysettings')}</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg" style={{ background: 'rgba(255, 179, 193, 0.1)' }}>
                <p className="text-sm mb-2" style={{ color: '#535353' }}>{t('page.text.activesessions')}</p>
                <p className="text-xs" style={{ color: '#848484' }}>{t('page.text.currentdevicewindows')}</p>
                <p className="text-xs mt-1" style={{ color: '#848484' }}>{t('page.text.lastactivejustnow')}</p>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'billing' && (
          <div className="finance-card p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 style={{ color: '#535353' }}>{t('page.heading.billingpayment')}</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg" style={{ background: 'rgba(255, 255, 255, 0.3)' }}>
                <p className="text-sm mb-2" style={{ color: '#535353' }}>{t('page.text.paymentmethods')}</p>
                <p className="text-xs" style={{ color: '#848484' }}>{t('page.text.nopaymentmethodssave')}</p>
                <Button
                  onClick={() => {}}
                  size="sm"
                  className="mt-3"
        ...
        {activeTab === 'preferences' && (
          <div className="finance-card p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 style={{ color: '#535353' }}>{t('page.heading.preferences')}</h2>
            </div>

            <div className="space-y-4">
              <div>
                <Label style={{ color: '#535353' }}>{t('page.text.language')}</Label>
                <select className="w-full mt-2 px-3 py-2 rounded-lg bg-white/50 border border-white/50" style={{ color: '#535353' }}>
                  <option>{t('page.text.english1')}</option>
                  <option>বাংলা (Bangla)</option>
                </select>
              </div>

              <div>
                <Label style={{ color: '#535353' }}>{t('page.text.timezone')}</Label>
                <select className="w-full mt-2 px-3 py-2 rounded-lg bg-white/50 border border-white/50" style={{ color: '#535353' }}>
              ...
              <div>
                <Label style={{ color: '#535353' }}>{t('page.text.dateformat')}</Label>
                <select className="w-full mt-2 px-3 py-2 rounded-lg bg-white/50 border border-white/50" style={{ color: '#535353' }}>
                  <option>{t('page.text.ddmmyyyy')}</option>
                  <option>{t('page.text.mmddyyyy')}</option>
                  <option>{t('page.text.yyyymmdd')}</option>
                </select>
              </div>
            </div>
          </div>
