  ...
  return (
    <>
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <h1 className="mb-2" style={{ color: '#535353' }}>{t('page.heading.productdetails')}</h1>
        ...
        <div className="finance-card p-6 mb-6">
          <div className="space-y-4">
            <div>
              <Label style={{ color: '#535353' }}>{t('page.text.productname')}</Label>
              <Input
                value={name}
            ...
            <div>
              <Label style={{ color: '#535353' }}>{t('page.text.description5')}</Label>
              <Textarea
                value={description}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label style={{ color: '#535353' }}>{t('page.text.stock')}</Label>
                <Input
                  type="number"
                  value={stock}
