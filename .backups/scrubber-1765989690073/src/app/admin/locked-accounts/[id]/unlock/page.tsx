    ...
    <>
      ...
      <div className="min-h-screen pb-6 pb-24 md:pt-14">
        <div className="p-6">
          ...
          <div className="mb-6">
            <h1 className="mb-2" style={{ color: '#535353' }}>{t('page.heading.manualaccountunlock')}</h1>
          ...
          <div className="finance-card p-6 mb-6">
            <h3 className="mb-4" style={{ color: '#535353' }}>{t('page.heading.accountinformation')}</h3>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span style={{ color: '#848484' }}>{t('page.text.accountid')}</span>
                <span style={{ color: '#535353' }}>{id}</span>
              </div>
              <div className="flex justify-between">
                <span style={{ color: '#848484' }}>{t('page.text.lockedsince')}</span>
                <span style={{ color: '#535353' }}>{t('page.text.dec12024')}</span>
              </div>
              <div className="flex justify-between">
                <span style={{ color: '#848484' }}>{t('page.text.outstandingbalance')}</span>
                <span className="font-semibold text-red-600">{t('page.text.bdt15000')}</span>
              </div>
              <div className="flex justify-between">
                <span style={{ color: '#848484' }}>{t('page.text.accounttype')}</span>
                <span style={{ color: '#535353' }}>{t('page.text.guardian')}</span>
              </div>
            </div>
          </div>
          ...
          <div className="finance-card p-6 mb-6">
            ...
            <Textarea
              ...
              placeholder={t('page.placeholder.egpaymentarrangement')}
          ...
          <div className="finance-card p-4 mb-6">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              />
              <div>
                <span style={{ color: '#535353' }}>{t('page.text.iconfirmthatihavever')}</span>
