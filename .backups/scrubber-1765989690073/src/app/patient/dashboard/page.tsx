    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-blue-950 pb-24 pb-24 md:pt-14">
        <div className="px-5 pt-6">
          <p className="text-sm" style={{ color: '#848484' }}>{t('page.text.tuesdaydec101')}</p>
          <h1 className="text-3xl font-semibold" style={{ color: '#535353' }}>{t('page.heading.helloanwar')}</h1>
          <p className="text-sm" style={{ color: '#848484' }}>{t('page.text.yourcaregiverarrives')}</p>
        </div>
        ...
        <div className="px-5 mt-5">
          <div className="finance-card p-5 rounded-3xl">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs" style={{ color: '#848484' }}>{t('page.text.todayaposscaregiver')}</p>
                <h2 className="text-xl font-semibold" style={{ color: '#535353' }}>{t('page.heading.shailakhatun1')}</h2>
        ...
        <div className="px-5 mt-5">
          <div className="finance-card p-5 rounded-3xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold" style={{ color: '#535353' }}>{t('page.heading.todayapossmedication')}</h3>
              <Link href="/patient/medications" className="text-sm" style={{ color: '#5B9FFF' }}>{t('page.text.viewall1')}</Link>
            </div>
        ...
        <div className="px-5 mt-5 grid grid-cols-2 gap-3">
          <Link href="/patient/care-logs">
            <div className="finance-card p-4 rounded-3xl text-center">
              ...
              <p className="text-sm font-semibold" style={{ color: '#535353' }}>{t('page.text.carelogs2')}</p>
            </div>
          </Link>
          <Link href="/patient/appointments">
            <div className="finance-card p-4 rounded-3xl text-center">
              <Calendar className="w-5 h-5 mx-auto mb-2" style={{ color: '#7CE577' }} />
              <p className="text-sm font-semibold" style={{ color: '#535353' }}>{t('page.text.appointments')}</p>
            </div>
          </Link>
        </div>
        ...
        <div className="px-5 mt-5 mb-16">
          <div className="finance-card p-5 rounded-3xl">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs" style={{ color: '#848484' }}>{t('page.text.nextreminder')}</p>
                <p className="text-lg font-semibold" style={{ color: '#535353' }}>{t('page.text.vitamindat800pm')}</p>
              </div>
              <Link href="/patient/medication-reminder" className="text-sm" style={{ color: '#5B9FFF' }}>{t('page.text.details')}</Link>
            </div>
          </div>
        </div>
      </div>
