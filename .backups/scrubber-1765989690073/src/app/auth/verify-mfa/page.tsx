...
export default function MFAVerificationPage() {
  ...
  const handleVerify = (verificationCode: string) => {
    ...
    // Mock verification - route to dashboard
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-md finance-card p-8">
        <h2 className="text-center mb-2" style={{ color: '#535353' }}>{t('page.heading.twofactorauthenticat')}</h2>
        ...
        <div className="text-center">
          <button
            onClick={() => alert('Backup code option would open here')}
