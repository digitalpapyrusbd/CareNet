    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 to-amber-50 dark:from-gray-900 dark:to-rose-950 px-4 py-10 pb-24 md:pt-14">
        <div className="w-full max-w-md finance-card p-8">
          <p className="text-sm mb-2" style={{ color: '#848484' }}>{t('page.text.step1of6')}</p>
          <h1 className="text-2xl font-semibold mb-3" style={{ color: '#535353' }}>{t('page.heading.verifyyourphonenumbe')}</h1>
          ...
          <Input
            type="tel"
            placeholder={t('page.placeholder.01xxxxxxxxx4')}
            value={phone}
