  ...
  return (
    <>
      ...
      <div className="w-full max-w-md finance-card p-8 text-center">
        <h2 className="mb-2" style={{ color: '#535353' }}>{t('page.heading.mfaverificationfaile')}</h2>
        ...
        <div className="finance-card p-4 mb-6">
          <p className="text-sm mb-2" style={{ color: '#535353' }}>{t('page.text.commonissues')}</p>
          <ul className="text-xs space-y-1 text-left" style={{ color: '#848484' }}>
            <li>• Code expired (codes are valid for 5 minutes)</li>
            <li>{t('page.text.incorrectcodeentered')}</li>
            <li>{t('page.text.timesyncissueonauthe')}</li>
          </ul>
        </div>
