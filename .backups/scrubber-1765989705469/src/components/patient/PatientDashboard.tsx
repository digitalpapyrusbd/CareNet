    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="p-6">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 text-left">
              <h2 style={{ color: '#535353' }}>{t('patientdashboard.heading.emergencysos')}</h2>
              <p className="text-sm" style={{ color: '#848484' }}>{t('patientdashboard.text.tapforimmediatehelp')}</p>
            </div>
          </div>
        </button>
        ...
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>{t('patientdashboard.heading.todayscaregiver')}</h3>
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 style={{ color: '#535353' }}>{t('patientdashboard.heading.todaysmedications')}</h3>
            <button
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <p className="text-sm text-center" style={{ color: '#535353' }}>{t('patientdashboard.text.callfamily')}</p>
          </button>
          ...
          <button className="finance-card p-4 hover:shadow-lg transition-all">
            ...
            <p className="text-sm text-center" style={{ color: '#535353' }}>{t('patientdashboard.text.schedule')}</p>
          </button>
          ...
          <button className="finance-card p-4 hover:shadow-lg transition-all">
            ...
            <p className="text-sm text-center" style={{ color: '#535353' }}>{t('patientdashboard.text.carelogs')}</p>
          </button>
          ...
          <button className="finance-card p-4 hover:shadow-lg transition-all">
            ...
            <p className="text-sm text-center" style={{ color: '#535353' }}>{t('patientdashboard.text.emergencies')}</p>
          </button>
        </div>
      </div>
      ...
      >
        <div className="flex items-center justify-around p-4">
          <button className="flex flex-col items-center gap-1">
            ...
            <span className="text-xs" style={{ color: '#FFB3C1' }}>{t('patientdashboard.text.home')}</span>
          </button>
          <button className="flex flex-col items-center gap-1">
            <Pill className="w-6 h-6" style={{ color: '#848484' }} />
            <span className="text-xs" style={{ color: '#848484' }}>{t('patientdashboard.text.medications')}</span>
          </button>
          <button className="flex flex-col items-center gap-1">
            <Calendar className="w-6 h-6" style={{ color: '#848484' }} />
            <span className="text-xs" style={{ color: '#848484' }}>{t('patientdashboard.text.schedule1')}</span>
          </button>
          <button className="flex flex-col items-center gap-1">
            <User className="w-6 h-6" style={{ color: '#848484' }} />
            <span className="text-xs" style={{ color: '#848484' }}>{t('patientdashboard.text.profile')}</span>
          </button>
        </div>
      </div>
    </div>
