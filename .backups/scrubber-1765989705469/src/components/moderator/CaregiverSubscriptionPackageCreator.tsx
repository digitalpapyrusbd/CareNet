  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          <h1 style={{ color: '#535353' }}>{t('caregiversubscriptionpackagecreator.heading.createcaregiversubsc')}</h1>
          <p style={{ color: '#848484' }}>{t('caregiversubscriptionpackagecreator.text.defineanewsubscripti')}</p>
        </div>

        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>{t('caregiversubscriptionpackagecreator.heading.basicinformation')}</h3>
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder={t('caregiversubscriptionpackagecreator.placeholder.egbasicpremium')}
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder={t('caregiversubscriptionpackagecreator.placeholder.describethispackage')}
                className="mt-2 bg-white/50 border-white/50"
                style={{ color: '#535353' }}
              />
            </div>
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 style={{ color: '#535353' }}>{t('caregiversubscriptionpackagecreator.heading.features')}</h3>
            ...
            {packageData.features.map((feature, index) => (
              <div key={index} className="flex gap-2">
                <Input
                  ...
                  placeholder={t('caregiversubscriptionpackagecreator.placeholder.enterfeaturedescript')}
