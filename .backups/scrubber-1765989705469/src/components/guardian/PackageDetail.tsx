  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <div className="p-6">
        ...
        {/* Description */}
        <div className="finance-card p-6 mb-4">
          <h3 className="mb-3" style={{ color: '#535353' }}>{t('packagedetail.heading.description')}</h3>
        ...
        {/* Inclusions */}
        <div className="finance-card p-6 mb-4">
          <h3 className="mb-3" style={{ color: '#535353' }}>{t('packagedetail.heading.whatsincluded')}</h3>
        ...
        {/* Exclusions */}
        <div className="finance-card p-6 mb-4">
          <h3 className="mb-3" style={{ color: '#535353' }}>{t('packagedetail.heading.notincluded')}</h3>
          <div className="space-y-2">
        ...
        <div className="finance-card p-6">
          <h3 className="mb-3" style={{ color: '#535353' }}>{t('packagedetail.heading.pricingbreakdown')}</h3>
          <div className="space-y-3">
            ...
            <div className="pt-3 border-t flex justify-between" style={{ borderColor: 'rgba(255, 255, 255, 0.5)' }}>
              <span className="font-semibold" style={{ color: '#535353' }}>{t('packagedetail.text.total')}</span>
        ...
        <div className="finance-card p-6 mt-4">
          <h3 className="mb-3" style={{ color: '#535353' }}>{t('packagedetail.heading.abouttheagency')}</h3>
