  ...
  return (
    <div className="min-h-screen pb-6">
      <div className="p-6 max-w-2xl mx-auto">
        <h1 className="mb-6" style={{ color: '#535353' }}>{t('shopsettings.heading.shopsettings')}</h1>
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 style={{ color: '#535353' }}>{t('shopsettings.heading.shopinformation')}</h3>
              <p className="text-sm" style={{ color: '#848484' }}>{t('shopsettings.text.basicshopdetails')}</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label>{t('shopsettings.text.description')}</Label>
              <Textarea
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <Label>{t('shopsettings.text.email')}</Label>
                <Input
                  type="email"
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 style={{ color: '#535353' }}>{t('shopsettings.heading.operatinghours')}</h3>
              <p className="text-sm" style={{ color: '#848484' }}>{t('shopsettings.text.shopopeningandclosin')}</p>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-3">
            <div>
              <Label>{t('shopsettings.text.openingtime')}</Label>
              <Input
                type="time"
            ...
            <div>
              <Label>{t('shopsettings.text.closingtime')}</Label>
              <Input
                type="time"
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 style={{ color: '#535353' }}>{t('shopsettings.heading.pricingdelivery')}</h3>
              <p className="text-sm" style={{ color: '#848484' }}>{t('shopsettings.text.orderanddeliverysett')}</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label>{t('shopsettings.text.acceptedpaymentmetho')}</Label>
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 style={{ color: '#535353' }}>{t('shopsettings.heading.notifications')}</h3>
              <p className="text-sm" style={{ color: '#848484' }}>{t('shopsettings.text.managenotificationpr')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-lg"
            ...
            <div>
              <p style={{ color: '#535353' }}>{t('shopsettings.text.ordernotifications')}</p>
              <p className="text-sm" style={{ color: '#848484' }}>{t('shopsettings.text.receivealertsfornewo')}</p>
            </div>
            <button
