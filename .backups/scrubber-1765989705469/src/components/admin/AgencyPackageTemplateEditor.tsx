    ...
    <div className="min-h-screen p-6">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 style={{ color: '#535353' }}>{t('agencypackagetemplateeditor.heading.editpackagetemplate')}</h1>
        ...
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>{t('agencypackagetemplateeditor.heading.basicinformation')}</h3>
          <div className="space-y-4">
            <div>
              <Label style={{ color: '#535353' }}>{t('agencypackagetemplateeditor.text.packagename')}</Label>
              <Input
            ...
            <div>
              <Label style={{ color: '#535353' }}>{t('agencypackagetemplateeditor.text.description')}</Label>
              <Textarea
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label style={{ color: '#535353' }}>{t('agencypackagetemplateeditor.text.caregiverlimit')}</Label>
                <Input
                  type="number"
        ...
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>{t('agencypackagetemplateeditor.heading.features')}</h3>
