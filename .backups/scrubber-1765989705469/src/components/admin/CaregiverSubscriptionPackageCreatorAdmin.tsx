...
interface CaregiverSubscriptionPackageCreatorAdminProps {
  onSave: (packageData: any) => void;
  onPreview: (packageData: any) => void;
}

export function CaregiverSubscriptionPackageCreatorAdmin({ onSave, onPreview }: CaregiverSubscriptionPackageCreatorAdminProps) {
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          <h1 style={{ color: '#535353' }}>{t('caregiversubscriptionpackagecreatoradmin.heading.createcaregiversubsc')}</h1>
          <p style={{ color: '#848484' }}>{t('caregiversubscriptionpackagecreatoradmin.text.admindefineanewsubsc')}</p>
        </div>

        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>{t('caregiversubscriptionpackagecreatoradmin.heading.basicinformation')}</h3>
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder={t('caregiversubscriptionpackagecreatoradmin.placeholder.egbasicpremium')}
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder={t('caregiversubscriptionpackagecreatoradmin.placeholder.describethispackage')}
                className="mt-2 bg-white/50 border-white/50"
                style={{ color: '#535353' }}
              />
            </div>
            ...
            <label className="flex items-center gap-3 p-3 rounded-lg cursor-pointer"
              ...
              <input
                ...
                className="w-5 h-5"
              />
              <span style={{ color: '#535353' }}>Active (visible to caregivers)</span>
            </label>
          </div>
        </div>
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 style={{ color: '#535353' }}>{t('caregiversubscriptionpackagecreatoradmin.heading.features')}</h3>
            ...
            {packageData.features.map((feature, index) => (
              <div key={index} className="flex gap-2">
                <Input
                  ...
                  placeholder={t('caregiversubscriptionpackagecreatoradmin.placeholder.enterfeaturedescript')}
