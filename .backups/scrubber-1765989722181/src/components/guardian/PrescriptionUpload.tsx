import { Upload, Camera, FileText, X, Check, Sparkles } from "lucide-react";
...
export function PrescriptionUpload({ patientId, onClose, onSave }: PrescriptionUploadProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center p-0 sm:items-center sm:p-6">
      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-t-2xl sm:rounded-2xl finance-card p-6">
        {/* Header */}
        <div className="flex items-center justify-between mb-6">
          <h2 style={{ color: '#535353' }}>{t('prescriptionupload.heading.uploadprescription')}</h2>
          <button
            onClick={onClose}
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              ...
              <div className="text-center">
                <p style={{ color: '#535353' }}>{t('prescriptionupload.text.clicktouploadprescri')}</p>
            ...
            <div className="text-center text-sm" style={{ color: '#848484' }}>{t('prescriptionupload.text.or')}</div>
        ...
        {isScanned && medications.length > 0 && (
          <div className="mb-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 style={{ color: '#535353' }}>{t('prescriptionupload.heading.extractedmedications')}</h3>
            </div>
              ...
              {medications.map((med, index) => (
                <div key={index} className="finance-card p-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                    <div>
                      <label className="text-xs mb-1 block" style={{ color: '#848484' }}>{t('prescriptionupload.text.medicationname')}</label>
                      <Input
                        value={med.name}
                    ...
                    <div>
                      <label className="text-xs mb-1 block" style={{ color: '#848484' }}>{t('prescriptionupload.text.dosage')}</label>
                      <Input
                        value={med.dosage}
                    ...
                    <div>
                      <label className="text-xs mb-1 block" style={{ color: '#848484' }}>{t('prescriptionupload.text.frequency')}</label>
                      <Input
                        value={med.frequency}
                    ...
                    <div>
                      <label className="text-xs mb-1 block" style={{ color: '#848484' }}>{t('prescriptionupload.text.duration')}</label>
                      <Input
                        value={med.duration}
