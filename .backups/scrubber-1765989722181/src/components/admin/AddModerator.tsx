    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md finance-card p-8">
        <div className="text-center mb-6">
          ...
          <h2 style={{ color: '#535353' }}>{t('addmoderator.heading.addnewmoderator')}</h2>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder={t('addmoderator.placeholder.enterfullname')}
          ...
          <div>
            ...
            <Input
              ...
              placeholder={t('addmoderator.placeholder.moderatorcarenetbd')}
              className="mt-2 bg-white/50 border-white/50"
              style={{ color: '#535353' }}
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              placeholder={t('addmoderator.placeholder.01xxxxxxxxx')}
              className="mt-2 bg-white/50 border-white/50"
              style={{ color: '#535353' }}
            />
          </div>
          ...
          <div>
            ...
            >
              <option value="standard">{t('addmoderator.text.standardmoderator')}</option>
              <option value="senior">{t('addmoderator.text.seniormoderator')}</option>
              <option value="lead">{t('addmoderator.text.leadmoderator')}</option>
            </select>
          </div>
