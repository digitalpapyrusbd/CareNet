  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 min-h-[400px] flex flex-col">
      <div className="flex items-start justify-between border-b border-gray-100 px-6 py-4">
        <div>
          <p className="text-sm text-gray-500">{t('jobdetailpanel.text.selectedjob')}</p>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-6">
        {loading && (
          <div className="text-center text-gray-500">{t('jobdetailpanel.text.loadingjobdetails')}</div>
        )}
          ...
          <>
            <section className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1">
                <p className="text-xs uppercase tracking-wide text-gray-500">{t('jobdetailpanel.text.patient')}</p>
              ...
              <div className="space-y-1">
                <p className="text-xs uppercase tracking-wide text-gray-500">{t('jobdetailpanel.text.primarycaregiver')}</p>
                <p className="text-base font-medium text-gray-900">
            ...
            <section className="grid gap-4 md:grid-cols-3">
              <div>
                <p className="text-xs uppercase text-gray-500">{t('jobdetailpanel.text.schedule')}</p>
              ...
              <div>
                <p className="text-xs uppercase text-gray-500">{t('jobdetailpanel.text.totalprice')}</p>
              ...
              <div>
                <p className="text-xs uppercase text-gray-500">{t('jobdetailpanel.text.paymentstatus')}</p>
                <p className="text-sm text-gray-900 font-medium">
            ...
            {job.specialInstructions && (
              <section className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                <p className="text-xs uppercase text-gray-500 mb-1">{t('jobdetailpanel.text.specialinstructions')}</p>
            ...
            <section>
              <div className="flex items-center justify-between mb-3">
                <div>
                  <p className="text-sm font-semibold text-gray-900">{t('jobdetailpanel.text.carelogs')}</p>
                  <p className="text-xs text-gray-500">{t('jobdetailpanel.text.latestcaregiverupdat')}</p>
                </div>
