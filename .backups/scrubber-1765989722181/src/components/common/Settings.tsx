  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-6 pt-6 pb-4">
        <h1 className="mb-1">{t('settings.heading.settings')}</h1>
        <p className="text-sm text-muted-foreground">{t('settings.text.manageyouraccountpre')}</p>
      </div>
        ...
        <Card className="modern-card p-5 border-0">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="mb-1">{t('settings.heading.aminakhan')}</h3>
      ...
      <div className="px-6 mt-8 mb-6">
        <Card className="modern-card p-4 border-0 text-center">
          <p className="text-sm text-muted-foreground mb-1">{t('settings.text.carenetversion')}</p>
