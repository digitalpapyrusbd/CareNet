    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md finance-card p-8">
        <div className="text-center mb-6">
          ...
          <h2 style={{ color: '#535353' }}>{t('agencyregistrationstep5.heading.payoutsetup')}</h2>
          <p className="text-sm" style={{ color: '#848484' }}>{t('agencyregistrationstep5.text.step5of5')}</p>
        </div>
            ...
            <>
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder={t('agencyregistrationstep5.placeholder.accountholdername')}
                  className="mt-2 bg-white/50 border-white/50"
                  style={{ color: '#535353' }}
                />
              </div>
                ...
                <>
                  <div>
                    ...
                    <Input
                      ...
                      placeholder={t('agencyregistrationstep5.placeholder.enterbankname')}
                      className="mt-2 bg-white/50 border-white/50"
                      style={{ color: '#535353' }}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder={t('agencyregistrationstep5.placeholder.enterbranchname')}
                      className="mt-2 bg-white/50 border-white/50"
                      style={{ color: '#535353' }}
                    />
                  </div>
                  ...
                  <div>
                    <Label style={{ color: '#535353' }}>{t('agencyregistrationstep5.text.routingnumber')}</Label>
                    <Input
                      value={accountDetails.routingNumber}
                      onChange={(e) => setAccountDetails({ ...accountDetails, routingNumber: e.target.value })}
                      placeholder={t('agencyregistrationstep5.placeholder.optional')}
                      className="mt-2 bg-white/50 border-white/50"
                      style={{ color: '#535353' }}
                    />
                  </div>
