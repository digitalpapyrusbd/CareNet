    ...
    <div className="min-h-screen p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <h1 className="mb-2" style={{ color: '#535353' }}>{t('caregiververification.heading.verificationprocess')}</h1>
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 style={{ color: '#535353' }}>{t('caregiververification.heading.overallprogress')}</h3>
          ...
          {currentStep === 1 && (
            <div>
              ...
              <ul className="space-y-2 mb-4 text-sm" style={{ color: '#848484' }}>
                <li>{t('caregiververification.text.caregivertrainingcer')}</li>
                <li>• First aid certification (if available)</li>
                <li>{t('caregiververification.text.specializedtrainingc')}</li>
              </ul>
              <Button
                style={{
