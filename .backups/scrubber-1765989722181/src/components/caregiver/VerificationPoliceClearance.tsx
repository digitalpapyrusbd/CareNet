  ...
  return (
    <div className="min-h-screen pb-6">
      <div className="p-6 max-w-2xl mx-auto">
        <div className="mb-6">
          <h1 className="mb-2" style={{ color: '#535353' }}>{t('verificationpoliceclearance.heading.step2policeclearance')}</h1>
          <p style={{ color: '#848484' }}>{t('verificationpoliceclearance.text.uploadyourpoliceclea')}</p>
        </div>
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 style={{ color: '#535353' }}>{t('verificationpoliceclearance.heading.policeclearancecerti')}</h3>
              <p className="text-sm" style={{ color: '#848484' }}>{t('verificationpoliceclearance.text.mustbeissuedwithinla')}</p>
            </div>
          </div>

          <div className="p-4 rounded-lg mb-6" style={{ background: 'rgba(142, 197, 252, 0.1)' }}>
            <p className="text-sm mb-2" style={{ color: '#535353' }}>{t('verificationpoliceclearance.text.requirements')}</p>
            <ul className="space-y-1 text-sm" style={{ color: '#848484' }}>
              <li>{t('verificationpoliceclearance.text.clearscanorphotoofce')}</li>
              <li>{t('verificationpoliceclearance.text.alltextmustbereadabl')}</li>
              <li>{t('verificationpoliceclearance.text.certificatemustbeval')}</li>
          ...
          <div className="border-2 border-dashed rounded-lg p-8 text-center"
            ...
            <p className="mb-2" style={{ color: '#535353' }}>{t('verificationpoliceclearance.text.dropfilehereorclickt')}</p>
            <input
              type="file"
