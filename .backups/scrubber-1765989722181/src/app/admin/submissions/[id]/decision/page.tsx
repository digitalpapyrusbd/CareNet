    ...
    <>
      ...
      <div className="min-h-screen pb-6 pb-24 md:pt-14">
        <div className="p-6">
          ...
          <div className="mb-6">
            <h1 className="mb-2" style={{ color: '#535353' }}>{t('page.heading.admindecision3way')}</h1>
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h3 style={{ color: '#535353' }}>{t('page.heading.approve')}</h3>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h3 style={{ color: '#535353' }}>{t('page.heading.sendbacktomoderator')}</h3>
                  <p className="text-sm" style={{ color: '#848484' }}>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h3 style={{ color: '#535353' }}>{t('page.heading.overridereject')}</h3>
                  <p className="text-sm" style={{ color: '#848484' }}>
          ...
          {(selectedDecision === 'send-back' || selectedDecision === 'override-reject') && (
            <div className="finance-card p-6 mb-6">
              ...
              <Textarea
                ...
                placeholder={t('page.placeholder.providedetailedfeedb')}
