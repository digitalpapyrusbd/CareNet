    ...
    <>
      ...
      <div className="min-h-screen pb-6 pb-24 md:pt-14">
        <div className="p-6">
          ...
          <div className="mb-6">
            <h1 className="mb-2" style={{ color: '#535353' }}>{t('page.heading.createcaregiversubsc')}</h1>
            <p style={{ color: '#848484' }}>{t('page.text.definesubscriptionpl1')}</p>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder={t('page.placeholder.egcaregiverprocaregi')}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{ color: '#535353' }}
                  >
                    <option value="monthly">{t('page.text.monthly1')}</option>
                    <option value="quarterly">{t('page.text.quarterly1')}</option>
                    <option value="yearly">{t('page.text.yearly1')}</option>
                  </select>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2 flex gap-2">
                  <Input
                    ...
                    placeholder={t('page.placeholder.addfeatureegpriority')}
