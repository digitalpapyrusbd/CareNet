  ...
  return (
    <>
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <h1 className="mb-2" style={{ color: '#535353' }}>{t('page.heading.activitylog')}</h1>
          <p style={{ color: '#848484' }}>Mrs. Fatima Ahmed - Today</p>
        </div>

        {/* Log New Activity */}
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>{t('page.heading.lognewactivity')}</h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Textarea
                ...
                placeholder={t('page.placeholder.egassistedwithaftern')}
            ...
            <div>
              <Label htmlFor="duration" style={{ color: '#535353' }}>{t('page.text.duration')}</Label>
              <input
                id="duration"
                type="text"
                value={duration}
                onChange={(e) => setDuration(e.target.value)}
                placeholder={t('page.placeholder.eg15minutes')}
        ...
        {/* Recent Activities */}
        <div className="mb-6">
          <h3 className="mb-3" style={{ color: '#535353' }}>{t('page.heading.recentactivities')}</h3>
