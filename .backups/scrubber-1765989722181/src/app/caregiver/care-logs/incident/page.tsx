      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 dark:from-gray-900 dark:to-amber-950 px-4 py-10 pb-24 md:pt-14">
        <div className="max-w-2xl mx-auto finance-card p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <p className="text-sm" style={{ color: '#848484' }}>{t('page.text.carelog1')}</p>
              <h1 className="text-2xl font-semibold" style={{ color: '#535353' }}>{t('page.heading.incidentreport')}</h1>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder={t('page.placeholder.detailwhathappenedwh')}
              />
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder={t('page.placeholder.describehowyourespon')}
              />
            </div>
          </div>
