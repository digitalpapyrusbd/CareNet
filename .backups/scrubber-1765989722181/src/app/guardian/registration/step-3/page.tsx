    ...
    <>
      ...
      <div className="w-full max-w-md mb-8">
        <div className="flex items-center justify-between mb-2">
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex items-center flex-1">
              ...
              >
                {3 > {t('page.text.s2')} <Check className="w-5 h-5" /> : s}
              </div>
              {s < 3 && (
                <div 
        ...
        <div className="flex justify-between text-xs" style={{ color: '#848484' }}>
          <span>{t('page.text.account2')}</span>
          <span>{t('page.text.verify2')}</span>
          <span>{t('page.text.profile2')}</span>
        </div>
      </div>

      {/* Card */}
      <div className="w-full max-w-md finance-card p-8">
        <h2 className="text-center mb-6" style={{ color: '#535353' }}>{t('page.heading.completeprofile')}</h2>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              id="fullName"
              type="text"
              placeholder={t('page.placeholder.enteryourfullname')}
              value={fullName}
          ...
          <div className="space-y-2">
            <Label htmlFor="photo" style={{ color: '#535353' }}>{t('page.text.profilephoto1')}</Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="language" style={{ color: '#535353' }}>{t('page.text.languagepreference')}</Label>
            <select
              id="language"
              value={language}
            ...
            >
              <option value="english">{t('page.text.english')}</option>
          ...
          <div className="space-y-3 pt-4">
            <div className="flex items-start gap-2">
              ...
              <Label htmlFor="terms" className="text-sm cursor-pointer" style={{ color: '#535353' }}>
                I accept the <Link href="/terms" className="hover:underline" style={{ color: '#FFB3C1' }}>{t('page.text.termsconditions')}</Link>
              </Label>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <Label htmlFor="privacy" className="text-sm cursor-pointer" style={{ color: '#535353' }}>
                I accept the <Link href="/privacy" className="hover:underline" style={{ color: '#FFB3C1' }}>{t('page.text.privacypolicy')}</Link>
              </Label>
            </div>
          </div>
