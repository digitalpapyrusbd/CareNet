      ...
      <div className="min-h-screen pb-6 pb-24 md:pt-14" style={{ background: 'linear-gradient(135deg, #E0F7FA 0%, #B2EBF2 50%, #80DEEA 100%)' }}>
        <div className="p-6 max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <h1 className="mb-2" style={{ color: '#535353' }}>Marketplace Applications</h1>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col md:flex-row gap-3">
                <div className="flex-1">
                  <label className="text-sm" style={{ color: '#535353' }}>Status</label>
                  <select
                ...
                <div className="flex-1">
                  <label className="text-sm" style={{ color: '#535353' }}>Company</label>
                  <select
                    className="w-full mt-1 bg-white/50 border rounded p-2"
                    value={companyId}
                ...
                <div className="flex-1">
                  <label className="text-sm" style={{ color: '#535353' }}>Search</label>
                  <input
                    className="w-full mt-1 bg-white/50 border rounded p-2"
                    placeholder="Job title or caregiver name/phone"
                    value={search}
              ...
              <div className="flex flex-col md:flex-row md:items-end gap-3">
                <div className="flex-1">
                  <label className="text-sm" style={{ color: '#535353' }}>From Date</label>
                  <input
                    type="date"
                    className="w-full mt-1 bg-white/50 border rounded p-2"
                    value={dateFrom}
                ...
                <div className="flex-1">
                  <label className="text-sm" style={{ color: '#535353' }}>To Date</label>
                  <input
                    type="date"
                    className="w-full mt-1 bg-white/50 border rounded p-2"
                    value={dateTo}
