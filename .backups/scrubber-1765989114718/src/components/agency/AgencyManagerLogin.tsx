...
interface AgencyManagerLoginProps {
  onLogin: (credentials: { email: string; password: string }) => void;
}

export function AgencyManagerLogin({ onLogin }: AgencyManagerLoginProps) {
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md finance-card p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="mb-2" style={{ color: '#535353' }}>Agency Manager</h1>
          <p className="text-sm" style={{ color: '#848484' }}>Quality & Operations Management</p>
        </div>
