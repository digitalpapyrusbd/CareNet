...
export function ModeratorLogin({ onLogin }: ModeratorLoginProps) {
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md finance-card p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="mb-2" style={{ color: '#535353' }}>Moderator Portal</h1>
          <p className="text-sm" style={{ color: '#848484' }}>Verification & Quality Control</p>
        </div>
