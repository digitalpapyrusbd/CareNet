import { User, Bell, Globe, Lock, Save, Mail, Phone } from "lucide-react";
...
export function UserSettings({ currentUser, onSave, onCancel }: UserSettingsProps) {
  const [settings, setSettings] = useState(currentUser);
  ...
  return (
    <div className="min-h-screen pb-6">
      <div className="p-6 max-w-2xl mx-auto">
        <h1 className="mb-6" style={{ color: '#535353' }}>Account Settings</h1>
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 style={{ color: '#535353' }}>Personal Information</h3>
              <p className="text-sm" style={{ color: '#848484' }}>Update your profile details</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative mt-2">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: '#848484' }} />
                <Input
                  type="email"
            ...
            <div>
              ...
              <div className="relative mt-2">
                <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: '#848484' }} />
                <Input
                  type="tel"
