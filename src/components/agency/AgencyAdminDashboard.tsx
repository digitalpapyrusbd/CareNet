              ...
              <div key={job.id} className="finance-card p-4">
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    <h4 style={{ color: '#535353' }}>{job.patient}</h4>
                ...
                {job.status === 'needs-assignment' ? (
                  <p className="text-sm" style={{ color: '#848484' }}>Start date: {job.date}</p>
                ) : (
                  <p className="text-sm" style={{ color: '#848484' }}>Caregiver: {job.caregiver}</p>
                )}
              </div>
            ))}
          </div>
