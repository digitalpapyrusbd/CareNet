      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 style={{ color: '#535353' }}>Terms & Conditions</h1>
        ...
        <div className="finance-card p-8 space-y-6">
          ...
          <section>
            <h2 className="mb-3" style={{ color: '#535353' }}>2. Acceptance of Terms</h2>
            <p style={{ color: '#535353' }}>
          ...
          <section>
            <h2 className="mb-3" style={{ color: '#535353' }}>3. User Roles and Responsibilities</h2>
            <div className="space-y-3" style={{ color: '#535353' }}>
              <div>
                <h3 className="mb-2">3.1 Guardians/Family Members</h3>
                <ul className="list-disc pl-5 space-y-1" style={{ color: '#535353' }}>
                  <li>Must provide accurate information about patients under their care</li>
                  <li>Responsible for payment of services booked through the Platform</li>
                  <li>Must maintain respectful communication with caregivers and agencies</li>
                </ul>
              </div>

              <div>
                <h3 className="mb-2">3.2 Caregivers</h3>
                <ul className="list-disc pl-5 space-y-1" style={{ color: '#535353' }}>
                  <li>Must undergo verification including background checks</li>
                  <li>Required to maintain professional conduct at all times</li>
                  <li>Must accurately log care activities and patient information</li>
                  <li>Responsible for timely check-in and check-out procedures</li>
                </ul>
              </div>

              <div>
                <h3 className="mb-2">3.3 Agencies</h3>
                <ul className="list-disc pl-5 space-y-1" style={{ color: '#535353' }}>
                  <li>Must maintain valid business licenses and certifications</li>
                  <li>Responsible for caregiver quality and performance</li>
                  <li>Must respond to booking inquiries within 24 hours</li>
                  <li>Required to maintain accurate pricing and service information</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="mb-3" style={{ color: '#535353' }}>4. Verification and Background Checks</h2>
            <p style={{ color: '#535353' }}>
          ...
          <section>
            <h2 className="mb-3" style={{ color: '#535353' }}>5. Payment Terms</h2>
          ...
          <section>
            <h2 className="mb-3" style={{ color: '#535353' }}>6. Dispute Resolution</h2>
            <p style={{ color: '#535353' }}>
          ...
          <section>
            <h2 className="mb-3" style={{ color: '#535353' }}>7. Data Privacy and Security</h2>
            <p style={{ color: '#535353' }}>
          ...
          <section>
            <h2 className="mb-3" style={{ color: '#535353' }}>8. Liability and Disclaimers</h2>
            <div className="space-y-2" style={{ color: '#535353' }}>
          ...
          <section>
            <h2 className="mb-3" style={{ color: '#535353' }}>9. Termination</h2>
            <p style={{ color: '#535353' }}>
          ...
          <section>
            <h2 className="mb-3" style={{ color: '#535353' }}>10. Changes to Terms</h2>
            <p style={{ color: '#535353' }}>
          ...
          <section>
            <h2 className="mb-3" style={{ color: '#535353' }}>11. Contact Information</h2>
            <p style={{ color: '#535353' }}>
