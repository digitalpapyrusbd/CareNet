      ...
      <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-t-2xl sm:rounded-2xl finance-card p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 style={{ color: '#535353' }}>Report Issue</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            <p className="text-sm" style={{ color: '#535353' }}>
              ⚠️ <strong>Important:</strong> False reports may result in account suspension. Our team will investigate all reports thoroughly.
            </p>
          </div>
