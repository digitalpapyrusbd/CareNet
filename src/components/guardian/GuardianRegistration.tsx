            ...
            <div className="space-y-3 pt-4">
              <div className="flex items-start gap-2">
                ...
                <Label htmlFor="terms" className="text-sm cursor-pointer" style={{ color: '#535353' }}>
                  I accept the <a href="#" className="hover:underline" style={{ color: '#FFB3C1' }}>Terms & Conditions</a>
                </Label>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <Label htmlFor="privacy" className="text-sm cursor-pointer" style={{ color: '#535353' }}>
                  I accept the <a href="#" className="hover:underline" style={{ color: '#FFB3C1' }}>Privacy Policy</a>
                </Label>
              </div>
            </div>
