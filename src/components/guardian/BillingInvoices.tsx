...
export function BillingInvoices({ type, onBack, onPayInvoice, onViewInvoice, onDownloadInvoice }: BillingInvoicesProps) {
  ...
  const invoices = {
    pending: [
      {
        id: "INV-2024-001",
        entity: type === 'agency' ? "Green Care Agency" : "CareNet Platform",
        amount: 35000,
        dueDate: "Dec 10, 2024",
    ...
    paid: [
      {
        id: "INV-2024-002",
        entity: type === 'agency' ? "MediCare Services" : "CareNet Platform",
        amount: 28000,
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <h1 className="mb-2" style={{ color: '#535353' }}>
            {type === 'agency' ? 'Agency Invoices' : 'Platform Fees'}
          </h1>
          <p style={{ color: '#848484' }}>
            {type === 'agency' 
              ? 'Invoices from care agencies for services provided'
              : 'Platform service fees and subscription charges'
            }
          </p>
        </div>
