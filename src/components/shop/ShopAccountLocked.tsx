    ...
    <div className="min-h-screen pb-6">
      <div className="p-6 max-w-2xl mx-auto">
        <div className="finance-card p-8 mb-6 text-center">
          ...
          <h1 className="mb-2" style={{ color: '#535353' }}>Account Locked</h1>
        ...
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>Account Restrictions</h3>

          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <XCircle className="w-5 h-5 mt-0.5" style={{ color: '#FF6B7A' }} />
              <div className="flex-1">
                <p style={{ color: '#535353' }}>Cannot process new orders</p>
                <p className="text-sm" style={{ color: '#848484' }}>Order processing is disabled</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <XCircle className="w-5 h-5 mt-0.5" style={{ color: '#FF6B7A' }} />
              <div className="flex-1">
                <p style={{ color: '#535353' }}>Cannot add new products</p>
                <p className="text-sm" style={{ color: '#848484' }}>Product listings are locked</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <XCircle className="w-5 h-5 mt-0.5" style={{ color: '#FF6B7A' }} />
              <div className="flex-1">
                <p style={{ color: '#535353' }}>Cannot update inventory</p>
                <p className="text-sm" style={{ color: '#848484' }}>Inventory management disabled</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p style={{ color: '#535353' }}>Can view existing orders</p>
                <p className="text-sm" style={{ color: '#848484' }}>Read-only access to order history</p>
              </div>
            </div>
