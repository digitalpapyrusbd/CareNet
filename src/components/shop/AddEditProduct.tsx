      ...
      <div className="p-6 max-w-2xl mx-auto">
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 style={{ color: '#535353' }}>Product Information</h3>
              <p className="text-sm" style={{ color: '#848484' }}>Basic product details</p>
            </div>
          </div>
        ...
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>Pricing & Inventory</h3>
        ...
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>Product Images</h3>
          ...
          <div className="border-2 border-dashed rounded-lg p-8 text-center mb-4"
            ...
            <p className="mb-2" style={{ color: '#535353' }}>Drop images here or click to browse</p>
            <input
              type="file"
              multiple
              accept="image/*"
