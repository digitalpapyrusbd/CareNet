...
interface AgencyLegalDocReviewProps {
  submissionId: string;
  agencyName: string;
...
export function AgencyLegalDocReview({
  submissionId,
  agencyName,
  moderatorName,
  moderatorDecision,
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <h1 style={{ color: '#535353' }}>Legal Document Review</h1>
        ...
        {/* Agency Information */}
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>Agency Information</h3>
          <div className="space-y-2">
            <div className="flex justify-between">
              <span style={{ color: '#848484' }}>Agency Name:</span>
              <span style={{ color: '#535353' }}>{agencyName}</span>
            </div>
            <div className="flex justify-between">
        ...
        {/* Documents */}
        <div className="finance-card p-6 mb-6">
          <h3 className="mb-4" style={{ color: '#535353' }}>Submitted Documents</h3>
