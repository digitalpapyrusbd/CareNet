...
export default function ShopAccountLockedPage() {
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-slate-200 dark:from-gray-900 dark:to-slate-950 px-4 py-10 pb-24 md:pt-14">
