...
export default function ShopAnalyticsPage() {
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen bg-gradient-to-b from-white to-purple-50 dark:from-gray-900 dark:to-purple-950 px-4 py-8 pb-24 md:pt-14">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl font-semibold mb-6" style={{ color: '#535353' }}>Shop Analytics</h1>
    ...
    <>
      <UniversalNav userRole="shop" showBack={true} />
          ...
          <div className="finance-card p-6 rounded-3xl mb-6">
            <h2 className="text-lg font-semibold mb-4" style={{ color: '#535353' }}>Top Products</h2>
          ...
          <div className="finance-card p-6 rounded-3xl">
            <h2 className="text-lg font-semibold mb-4" style={{ color: '#535353' }}>Revenue by Category</h2>
            <div className="space-y-2 text-sm">
              <div className="flex items-center justify-between">
                <span style={{ color: '#848484' }}>Medical Devices</span>
                <span style={{ color: '#535353' }}>142K (50%)</span>
              </div>
              <div className="flex items-center justify-between">
                <span style={{ color: '#848484' }}>Equipment Sales</span>
                <span style={{ color: '#535353' }}>98K (35%)</span>
              </div>
              <div className="flex items-center justify-between">
                <span style={{ color: '#848484' }}>Equipment Rentals</span>
