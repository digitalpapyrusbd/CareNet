...
export default function ShopRegistrationPage() {
  ...
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 dark:from-gray-900 dark:to-purple-950 px-4 py-10 pb-24 md:pt-14">
        <div className="max-w-3xl mx-auto finance-card p-8">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-semibold" style={{ color: '#535353' }}>Shop Registration</h1>
            <p className="text-sm" style={{ color: '#848484' }}>Register your medical equipment or pharmacy shop</p>
          </div>

          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium" style={{ color: '#535353' }}>Shop Name *</label>
              <Input value={form.shopName} onChange={(e) => update('shopName', e.target.value)} className="mt-2 bg-white/60 border-white/60" placeholder="e.g., MedCare Pharmacy" />
            </div>
            ...
            <div>
              ...
              <Textarea value={form.address} onChange={(e) => update('address', e.target.value)} className="mt-2 bg-white/60 border-white/60" rows={3} placeholder="Complete address with area and landmarks" />
            </div>
            ...
            <div>
              ...
              <div className="mt-2 p-6 rounded-2xl border-2 border-dashed text-center" style={{ borderColor: 'rgba(255,255,255,0.5)', background: 'rgba(255,255,255,0.3)' }}>
                <p className="text-sm" style={{ color: '#535353' }}>Trade License, TIN Certificate, Shop Photos</p>
                <input type="file" multiple className="hidden" id="docs" />
                <label htmlFor="docs">
                  <Button type="button" variant="outline" className="mt-3 bg-white/50 border-white/50">Select Files</Button>
                </label>
              </div>
            </div>
          </div>
