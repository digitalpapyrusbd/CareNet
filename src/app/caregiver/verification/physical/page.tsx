  ...
  return (
    <>
      ...
      <div className="p-6 max-w-2xl mx-auto">
        <div className="mb-6">
          <h1 className="mb-2" style={{ color: '#535353' }}>Step 5: Physical Health Check</h1>
          <p style={{ color: '#848484' }}>Upload your physical health examination report</p>
        </div>
        ...
        <div className="finance-card p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 style={{ color: '#535353' }}>Physical Health Certificate</h3>
              <p className="text-sm" style={{ color: '#848484' }}>Issued within last 3 months</p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-lg mb-6" style={{ background: 'rgba(168, 224, 99, 0.1)' }}>
            ...
            <ul className="space-y-1 text-sm" style={{ color: '#848484' }}>
              <li>• General health examination report</li>
              <li>• No communicable diseases</li>
              <li>• Physically fit for caregiving duties</li>
              <li>• Signed by registered medical practitioner</li>
            </ul>
          </div>
