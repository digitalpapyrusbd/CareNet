...
export default function VerificationCertificatesPage() {
  const [status] = useState<
    "submitted" | "under-review" | "approved" | "needs-resubmission"
  >("under-review");
  ...
  const [feedback] = useState(
    "Your certificates are being reviewed by our team. This usually takes 2-3 hours.",
  );
    ...
    switch (status) {
      ...
      case "under-review":
        return {
          ...
          label: "Under Review",
          message:
            "Your certificates are being reviewed. Estimated time: 2-3 hours.",
        };
      default:
        return {
          icon: FileText,
  ...
  return (
    ...
    >
      ...
      {/* Status Message */}
      <div
        className="finance-card p-5 mb-6"
      ...
      <div className="flex-1">
        ...
        <div className="space-y-3 mb-6">
          {certificates.map((cert, index) => (
            <div
              key={index}
              className="finance-card p-4 flex items-center justify-between"
            >
        ...
        {/* Info */}
        <div
          className="finance-card p-4 mt-6"
          style={{ background: "rgba(254, 180, 197, 0.1)" }}
        >
          <p className="text-sm" style={{ color: "#848484" }}>
