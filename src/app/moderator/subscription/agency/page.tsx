    ...
    <>
      ...
      <div className="min-h-screen pb-6 pb-24 md:pt-14">
        <div className="p-6">
          ...
          <div className="mb-6">
            <h1 className="mb-2" style={{ color: '#535353' }}>Create Agency Subscription Package</h1>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="E.g., Basic Plan, Premium Plan, Enterprise Plan"
              ...
              <div>
                ...
                <div className="mt-2 flex gap-2">
                  <Input
                    ...
                    placeholder="Add feature (e.g., Up to 10 caregivers)"
