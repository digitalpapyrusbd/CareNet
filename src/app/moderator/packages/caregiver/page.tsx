  ...
  return (
    <>
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <h1 className="mb-2" style={{ color: '#535353' }}>Create Caregiver Package Template</h1>
          <p style={{ color: '#848484' }}>Define reusable package templates for independent caregivers</p>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="E.g., Basic Home Care - Hourly"
