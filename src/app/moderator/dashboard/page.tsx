...
export default function ModeratorDashboardPage() {
  ...
  return (
    ...
    <div className= pb-24 md:pt-14"min-h-screen pb-6 pb-24 md:pt-14">
      {/* Header */}
      <div className="p-6">
        <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          ...
          <div className="finance-card p-4">
            ...
            <Button
              onClick={() => router.push('/moderator/disputes')}
              size="sm"
              className="w-full"
              style={{
                background: 'radial-gradient(143.86% 887.35% at -10.97% -22.81%, #FFD180 0%, #FFB74D 100%)',
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          ...
          >
            ...
            <p className="text-xs text-center" style={{ color: '#535353' }}>Tickets</p>
          </button>
        </div>
            ...
            {recentActivity.map((activity) => (
              <div key={activity.id} className="finance-card p-4">
                <div className="flex items-start gap-3">
                  ...
                  >
                    {activity.type === 'verification' ? <CheckCircle className="w-5 h-5 text-white" /> : <Shield className="w-5 h-5 text-white" />}
                  </div>
                  <div className="flex-1">
                    <p style={{ color: '#535353' }}>{activity.action}</p>
                    {activity.user && <p className="text-sm" style={{ color: '#848484' }}>{activity.user}</p>}
