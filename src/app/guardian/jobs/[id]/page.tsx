    ...
    <>
      ...
      <div className="p-6">
        ...
        <div className="finance-card p-4 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex gap-2">
              <button
                onClick={() => router.push('/guardian/messages/123')}
              ...
              <a
                ...
                aria-label={`Call ${job.caregiver.name}`}
              >
        ...
        <div className="grid grid-cols-2 gap-3 mt-6">
          <Button
            onClick={() => router.push('/guardian/report-issue')}
            variant="outline"
          ...
          <Button
            onClick={() => router.push('/guardian/rate-review')}
            style={{
              background: 'radial-gradient(143.86% 887.35% at -10.97% -22.81%, #FFB3C1 0%, #FF8FA3 100%)',
              color: 'white'
            }}
