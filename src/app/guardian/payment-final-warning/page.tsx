      ...
      <div className= pb-24 md:pt-14"min-h-screen pb-6 pb-24 md:pt-14">
        ...
        <div className="bg-gradient-to-r from-red-500 to-rose-600 text-white">
          <div className="max-w-3xl mx-auto px-4 py-8 space-y-1">
            <p className="text-sm text-red-100 uppercase tracking-wide">Final Warning</p>
            <h1 className="text-3xl font-bold">Account Lock Imminent</h1>
          ...
          <div className="finance-card p-6 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <div className="text-right">
                <p className="text-sm text-red-500">Locking tomorrow</p>
