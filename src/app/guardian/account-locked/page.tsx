...
export default function GuardianAccountLockedPage() {
  const router = useRouter();
  const outstandingAmount = 15000;
  const daysPastDue = 12;
  ...
  return (
    ...
    <div className= pb-24 md:pt-14"min-h-screen flex flex-col items-center justify-center p-6 pb-24 md:pt-14">
      {/* Lock Icon */}
      <div 
