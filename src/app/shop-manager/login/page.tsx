...
export default function ShopManagerLoginPage() {
  ...
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-100 dark:from-gray-900 dark:to-indigo-950 px-4 py-12 pb-24 md:pt-14">
