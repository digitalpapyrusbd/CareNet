...
export default function ShopManagerRestrictionsPage() {
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen bg-gradient-to-b from-slate-50 to-gray-100 dark:from-gray-900 dark:to-slate-950 px-4 py-8 pb-24 md:pt-14">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-semibold mb-6" style={{ color: '#535353' }}>Manager Access Permissions</h1>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="finance-card p-6 rounded-3xl">
              <div className="flex items-center gap-3 mb-4">
                <CheckCircle className="w-6 h-6" style={{ color: '#2E7D32' }} />
                <h2 className="text-lg font-semibold" style={{ color: '#535353' }}>What You Can Do</h2>
              </div>
            ...
            <div className="finance-card p-6 rounded-3xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg font-semibold" style={{ color: '#535353' }}>Restricted Actions</h2>
              </div>
              <ul className="space-y-2 text-sm">
                {restricted.map((item) => (
                  <li key={item} className="flex items-start gap-2" style={{ color: '#535353' }}>
