...
export default function ShopManagerDashboardPage() {
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen bg-gradient-to-b from-indigo-50 to-purple-100 dark:from-gray-900 dark:to-purple-950 px-4 py-8 pb-24 md:pt-14">
