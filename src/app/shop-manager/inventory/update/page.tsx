...
export default function ShopManagerUpdateStockPage() {
  ...
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen bg-gradient-to-br from-emerald-50 to-green-100 dark:from-gray-900 dark:to-emerald-950 px-4 py-10 pb-24 md:pt-14">
