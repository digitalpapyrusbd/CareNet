...
export default function ShopManagerInventoryPage() {
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen bg-gradient-to-b from-green-50 to-emerald-100 dark:from-gray-900 dark:to-emerald-950 px-4 py-8 pb-24 md:pt-14">
