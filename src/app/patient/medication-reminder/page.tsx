...
export default function PatientMedicationReminderPage() {
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-yellow-100 dark:from-gray-900 dark:to-amber-950 px-4 py-10 pb-24 md:pt-14">
        <div className="w-full max-w-md finance-card p-8 text-center">
          ...
          <p className="text-sm mb-1" style={{ color: '#848484' }}>Reminder</p>
          <h1 className="text-2xl font-semibold mb-2" style={{ color: '#535353' }}>Vitamin D (1000 IU)</h1>
