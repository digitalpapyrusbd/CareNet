...
export default function PatientCareLogsPage() {
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen bg-gradient-to-b from-white to-slate-50 dark:from-gray-900 dark:to-slate-950 px-4 py-8 pb-24 md:pt-14">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl font-semibold mb-1" style={{ color: '#535353' }}>Today&apos;s Care Logs</h1>
