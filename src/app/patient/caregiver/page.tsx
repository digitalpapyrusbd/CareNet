      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-100 dark:from-gray-900 dark:to-rose-950 px-4 py-10 pb-24 md:pt-14">
        <div className="max-w-2xl mx-auto finance-card p-8">
          <div className="flex items-center gap-5 mb-6">
            ...
            <div>
              <p className="text-sm" style={{ color: '#848484' }}>Assigned Caregiver</p>
              <h1 className="text-2xl font-semibold" style={{ color: '#535353' }}>Shaila Khatun</h1>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <div className="p-4 rounded-2xl" style={{ background: 'rgba(255,255,255,0.6)' }}>
              ...
              <p className="text-lg font-semibold" style={{ color: '#535353' }}>5 years</p>
            </div>
            <div className="p-4 rounded-2xl" style={{ background: 'rgba(255,255,255,0.6)' }}>
              <p className="text-xs" style={{ color: '#848484' }}>Specialties</p>
              <p className="text-lg font-semibold" style={{ color: '#535353' }}>Post-Surgery, Diabetes</p>
            </div>
          </div>

          <div className="mb-6">
            <h2 className="text-lg font-semibold mb-3" style={{ color: '#535353' }}>Certifications</h2>
            <ul className="space-y-2 text-sm" style={{ color: '#535353' }}>
              <li> Nursing Diploma - Dhaka Medical College</li>
              <li> CareNet Psychological Screening - Passed</li>
              <li> Advanced Wound Care Training</li>
            </ul>
          </div>

          <div className="mb-6">
            <h2 className="text-lg font-semibold mb-3" style={{ color: '#535353' }}>Recent Reviews</h2>
            <div className="space-y-3">
              <div className="p-4 rounded-2xl" style={{ background: 'rgba(255,255,255,0.7)' }}>
                ...
                <p className="text-xs mt-2" style={{ color: '#848484' }}> Fahima Rahman</p>
              </div>
              <div className="p-4 rounded-2xl" style={{ background: 'rgba(255,255,255,0.7)' }}>
                <p className="text-sm" style={{ color: '#535353' }}>Helped my father recover faster with daily exercises.</p>
                <p className="text-xs mt-2" style={{ color: '#848484' }}> Selina Rahman</p>
              </div>
            </div>
          </div>
