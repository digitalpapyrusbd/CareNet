      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
                <h3 className="font-medium text-gray-900 dark:text-white mb-3">{t('page.heading.splitexportrecommend')}</h3>
        ...
        {activeTab === 'import' && (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="languageCode">{t('page.text.languagecode1')}</Label>
                <Input
                  id="languageCode"
                  type="text"
                  value={languageCode}
                  onChange={(e) => setLanguageCode(e.target.value.toLowerCase())}
                  placeholder={t('page.placeholder.egfresar1')}
                  className="mt-1"
                />
                    ...
                    >
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-700 dark:text-gray-300 mb-1">
                          <strong>{t('page.text.text')}</strong> "{issue.text}"
                        </p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          <strong>{t('page.text.suggestedkey')}</strong> <code className="bg-gray-100 dark:bg-gray-900 px-1 rounded">{issue.suggestedKey}</code>
                        </p>
                      </div>
                    </div>
                  ))}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="mb-6">
              ...
              <div className="flex items-center gap-4">
                <div>
                  <Label htmlFor="editorLanguage">{t('page.text.targetlanguage')}</Label>
                  <select
                    id="editorLanguage"
