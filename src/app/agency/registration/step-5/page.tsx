...
export default function AgencyRegistrationStep5Page() {
  ...
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 dark:from-gray-900 dark:to-emerald-950 px-4 py-10 pb-24 md:pt-14">
        <div className="max-w-2xl mx-auto finance-card p-8">
          <p className="text-sm mb-2" style={{ color: '#848484' }}>Step 5 of 5</p>
          <h1 className="text-2xl font-semibold mb-4" style={{ color: '#535353' }}>Payout Setup</h1>
          <p className="text-sm mb-6" style={{ color: '#848484' }}>Configure how you receive payments</p>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Input value={accountName} onChange={(e) => setAccountName(e.target.value)} className="mt-2 bg-white/60 border-white/60" placeholder="Name as per account" />
            </div>
            ...
            {paymentMethod === 'bank' && (
              <>
                <div>
                  ...
                  <Input value={bankName} onChange={(e) => setBankName(e.target.value)} className="mt-2 bg-white/60 border-white/60" placeholder="e.g., Dutch-Bangla Bank" />
                </div>
                <div>
                  <label className="text-sm font-medium" style={{ color: '#535353' }}>Branch Name *</label>
                  <Input value={branchName} onChange={(e) => setBranchName(e.target.value)} className="mt-2 bg-white/60 border-white/60" placeholder="e.g., Gulshan Branch" />
                </div>
              </>
            )}
          </div>
          ...
          <div className="mt-6 p-4 rounded-2xl" style={{ background: 'rgba(168,224,99,0.1)' }}>
            <p className="text-xs" style={{ color: '#535353' }}>Progress: 100% complete</p>
