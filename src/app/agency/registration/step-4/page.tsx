...
export default function AgencyRegistrationStep4Page() {
  ...
  return (
    ...
    <Layout>
      <div className= pb-24 md:pt-14"min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 dark:from-gray-900 dark:to-purple-950 px-4 py-10 pb-24 md:pt-14">
