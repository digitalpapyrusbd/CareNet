...
export class SubscriptionsController {
    ...
    @Post()
    create(@CurrentUser('company_id') companyId: string, @Body() createDto: CreateSubscriptionDto) {
    ...
    @Patch('upgrade')
    upgrade(@CurrentUser('company_id') companyId: string, @Body() updateDto: UpdateSubscriptionDto) {
