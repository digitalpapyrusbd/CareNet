...
describe('PaymentsService', () => {
    ...
    describe('createPayment', () => {
        ...
        it('should throw NotFoundException if job does not exist', async () => {
            ...
            await expect(service.createPayment(userId, createDto)).rejects.toThrow(NotFoundException);
        });
        ...
        it('should throw BadRequestException if user is not the guardian', async () => {
            ...
            await expect(service.createPayment(userId, createDto)).rejects.toThrow(BadRequestException);
        });
    });
    ...
    describe('processPayment', () => {
        ...
        it('should throw NotFoundException if payment does not exist', async () => {
            ...
            await expect(service.processPayment(processDto)).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('refundPayment', () => {
        ...
        it('should throw BadRequestException if payment is not COMPLETED', async () => {
            ...
            await expect(service.refundPayment('pay1', refundDto)).rejects.toThrow(BadRequestException);
        });
    });
    ...
    describe('releaseEscrow', () => {
        ...
        it('should throw NotFoundException if escrow not found', async () => {
            ...
            await expect(service.releaseEscrow('pay1')).rejects.toThrow(NotFoundException);
        });
    });
});
