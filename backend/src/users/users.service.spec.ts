...
describe('UsersService', () => {
    ...
    describe('findOne', () => {
        it('should return a user if found and authorized', async () => {
            ...
            const result = await service.findOne('user-1', 'user-1', UserRole.CAREGIVER);
        ...
        it('should allow Admin to view any profile', async () => {
            ...
            const result = await service.findOne('other-user', 'admin-id', UserRole.SUPER_ADMIN);
            expect(result).toEqual(mockUser);
        });
    });
    ...
    describe('update', () => {
        it('should update user profile', async () => {
            ...
            const result = await service.update('user-1', updateDto, 'user-1', UserRole.CAREGIVER);
