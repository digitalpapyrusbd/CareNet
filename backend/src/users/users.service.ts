...
import { UpdateUserDto, UpdateUserStatusDto, ChangeRoleDto } from './dto/update-user.dto';
...
export class UsersService {
    ...
    async getStatistics() {
        const [
            ...
            this.prisma.users.count({ where: { is_active: true, deleted_at: null } }),
            this.prisma.users.count({ where: { kyc_status: 'VERIFIED', deleted_at: null } }),
