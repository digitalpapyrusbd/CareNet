...
import { CreateNegotiationDto, RespondNegotiationDto } from './dto/negotiation.dto';
...
export class NegotiationsController {
    ...
    create(@CurrentUser('id') userId: string, @Body() createDto: CreateNegotiationDto) {
        return this.negotiationsService.create(userId, createDto);
    }

    @Get()
    findAll(@CurrentUser('id') userId: string, @Query() query: any) {
        return this.negotiationsService.findAll(userId, query.page, query.limit);
    }
