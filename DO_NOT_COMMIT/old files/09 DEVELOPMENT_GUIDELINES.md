...
Mobile: Standardize on React Native with Expo for mobile app development (remove Flutter references in other documents)
...
// Normalization transform (optional) — keep phone in +8801XXXXXXXXX format
export const normalizeBangladeshPhone = (phone: string) => {
  if (phone.startsWith('01')) return '+880' + phone.substring(1);
  return phone;
};

// Rate limiting guidance (Upstash + @upstash/ratelimit)
