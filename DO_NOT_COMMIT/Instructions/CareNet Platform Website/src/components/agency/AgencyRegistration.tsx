      ...
      <div className="p-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-6 text-center">
            <h1 className="mb-2" style={{ color: '#535353' }}>Agency Registration</h1>
            ...
            <div className="finance-card p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#848484' }}>Tell us about your agency</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Green Care Services Ltd."
          ...
          {currentStep === 2 && (
            <div className="finance-card p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 style={{ color: '#535353' }}>Contact Information</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="info@greencare.com"
                    className="mt-2 bg-white/50 border-white/50"
                    style={{ color: '#535353' }}
                  />
                </div>
          ...
          {currentStep === 3 && (
            <div className="finance-card p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 style={{ color: '#535353' }}>Legal Documents</h2>
                  <p className="text-sm" style={{ color: '#848484' }}>Upload required certificates</p>
                </div>
              </div>
                    ...
                    >
                      {doc.file ? (
                        ...
                        <>
                          ...
                          <span className="text-sm" style={{ color: '#848484' }}>Click to upload PDF or image</span>
                        </>
                      )}
                      <input
                        type="file"
          ...
          {currentStep === 4 && (
            <div className="finance-card p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 style={{ color: '#535353' }}>Physical Verification</h2>
                  <p className="text-sm" style={{ color: '#848484' }}>Office location and photos</p>
                </div>
              </div>
          ...
          {currentStep === 5 && (
            <div className="finance-card p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 style={{ color: '#535353' }}>Admin Account</h2>
                  <p className="text-sm" style={{ color: '#848484' }}>Create agency administrator account</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {confirmPassword && password !== confirmPassword && (
                    <p className="text-xs mt-1" style={{ color: '#FF6B7A' }}>Passwords do not match</p>
                  )}
                </div>
              </div>
            </div>
