  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-6 space-y-3">
        ...
        {/* Disputed Jobs */}
        {activeTab === 'disputed' && jobs.disputed.length === 0 && (
          <div className="text-center py-12">
            <CheckCircle className="w-12 h-12 mx-auto mb-4" style={{ color: '#7CE577' }} />
            <p style={{ color: '#535353' }}>No disputed jobs</p>
            <p className="text-sm" style={{ color: '#848484' }}>All your jobs are running smoothly!</p>
          </div>
        )}
